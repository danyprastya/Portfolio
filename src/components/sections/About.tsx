...
const EmailDialog = ({ email }: { email: string }) => {
  ...
  const onSubmit = async (formData: EmailFormData) => {
    try {
      // Start border trail animation when form is submitted
      ...
      // Hide border trail after completion
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        ...
        <DialogHeader>
          ...
          <DialogDescription className="font-sans text-neutral-600 dark:text-neutral-400">
        ...
        >
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              />
              {errors.name && (
                <span className="text-red-500 text-[10px] font-sans">
                  {errors.name.message}
                </span>
              )}
            </div>
